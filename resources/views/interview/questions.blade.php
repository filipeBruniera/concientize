...
<div class="interview-container">
    ...
    <form action="/interview" method="POST">
        ...
        <div class="form-group">
            <label for="question1">Você aceita fazer uma entrevista para a matéria vida e carreira a respeito da lei que
                fala sobre maus tratos animais?</label>
            <input type="text" name="question1" required>
        </div>

        <!-- Question 2 -->
        <div class="form-group">
            <label for="question2">Permite a utilização da sua imagem para elaboração do trabalho de apresentação em
                sala de aula?</label>
